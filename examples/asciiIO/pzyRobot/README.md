...
This Arduino sketch implements position control of the pipettor axis, the z axis, and the y axis. The Arduino can be controlled over a Serial connection (such as from the Arduino's Serial Monitor) with human-readable command and response messages.
