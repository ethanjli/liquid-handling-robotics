...
This Arduino sketch implements position control of the pipettor axis and the z axis. The Arduino must be controlled over a Serial Firmata connection (such as from Snap4Arduino).
